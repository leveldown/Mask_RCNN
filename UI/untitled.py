...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 181, 171))
        ...
        self.label.setGeometry(QtCore.QRect(10, 180, 721, 401))
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(220, 0, 451, 41))
        ...
        self.pushButton_4.clicked.connect(MainWindow.show_img)
